...
function pairingCompletePage(): Response {
  const html = `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Watch paired</title><style>body{font:18px system-ui;max-width:34rem;margin:10vh auto;padding:1.25rem;background:#111;color:#fff}strong{color:#fb923c}</style></head><body><h1>Watch paired</h1><p><strong>Return to your Garmin watch</strong> and press Select to finish.</p></body></html>`;

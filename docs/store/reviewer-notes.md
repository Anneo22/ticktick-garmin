...
Status: incomplete until physical acceptance and the reviewer account procedure are ready.

The app requires a TickTick OAuth grant. On first launch, press Select to create a pairing code. Open [the public pairing page](https://ticktick-garmin-relay.russo-emanuele22.workers.dev/pair), enter the code, approve TickTick access, then press Select on the watch again.

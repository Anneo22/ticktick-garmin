...
[![Checks](https://github.com/Anneo22/ticktick-garmin/actions/workflows/checks.yml/badge.svg)](https://github.com/Anneo22/ticktick-garmin/actions/workflows/checks.yml)
...
That validates the watch-relay fixtures, type-checks the Worker, and runs 32 relay tests without needing Garmin's SDK.
...
The full command compiles all 126 SDK product targets and runs 25 Monkey C tests on both Fenix 8 and the 96 KiB Instinct 2S target. Build the signed Store package with:
